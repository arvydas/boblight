...
BOBLIGHT_OPTION(autospeed,     bool,  -1,              -1,                0,      m_autospeed,     send = true;)
BOBLIGHT_OPTION(interpolation, bool,  -1,              -1,                0,      m_interpolation, send = true;)
BOBLIGHT_OPTION(use,           bool,  -1,              -1,                0,      m_use,           send = true;)
